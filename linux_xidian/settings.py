# Django settings for linux_xidian project.
import os
DEBUG = True
...
SECRET_KEY = '7ot(s)q*e$la70rp0%&%zn&w^7j861+s2=toe0hui%6964%ht_'
...
ROOT_URLCONF = 'linux_xidian.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'linux_xidian.wsgi.application'

#template_dir_path = os.path.join(os.getcwd(),'templates')
TEMPLATE_DIRS = (
...
INSTALLED_APPS = (
    ...
    'linux_xidian.apps.mirrors_status',
)
